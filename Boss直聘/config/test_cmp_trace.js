/**
 * Compare VMP execution between Node.js and Browser
 * Runs the security JS with same seed/ts and outputs trace for comparison
 */
var vm = require('vm');
var fs = require('fs');
...
// Browser classes (same as sign_boss_v5.js)
...
doc.visibilityState = 'visible'; doc.title = 'BOSS直聘'; doc.all = undefined;
var _docCookie = '';
Object.defineProperty(doc, 'cookie', {
    get: function() { return _docCookie || ('__a=0.0..0.1.1.1.1;__c=0;__g=-'); },
...
var scr = new Scr_(); scr.width = 1600; scr.height = 900; scr.availWidth = 1600; scr.availHeight = 860; scr.colorDepth = 24; scr.pixelDepth = 24;
...
var perf = new Perf_(); perf.now = function() { return Date.now(); }; sn(perf.now, 'now'); perf.memory = {};
...
try {
    ...
    console.log('Token: ' + result.substring(0, 80));
} catch(e) {
