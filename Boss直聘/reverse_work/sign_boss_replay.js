/**
 * sign_boss_replay.js — VMP Replay token generator
 * Forces exact browser path via trace replay
 */
var fs = require('fs');
var seed = process.argv[2] || 'test123';
var ts = parseInt(process.argv[3] || '1700000000000');
var seccode = fs.readFileSync(__dirname + '/config/security-replay.js', 'utf8');

// Minimal env matching Camoufox browser
...
global.innerWidth = 1920; global.innerHeight = 976;
global.outerWidth = 1920; global.outerHeight = 1037;
global.devicePixelRatio = 1;

var _lsObj = {};
global.localStorage = { setItem: function (a, b) { _lsObj[a] = b; }, getItem: function (a) { return _lsObj[a] || null; }, key: function () { return null; }, length: 0 };
...
global.performance = {
    ...
    timing: {
        navigationStart: _perfNow, fetchStart: _perfNow,
        domainLookupStart: _perfNow, domainLookupEnd: _perfNow,
        connectStart: _perfNow, connectEnd: _perfNow,
        requestStart: _perfNow, responseStart: _perfNow,
        responseEnd: _perfNow, domLoading: _perfNow,
        domInteractive: _perfNow, domContentLoadedEventStart: _perfNow,
        domContentLoadedEventEnd: _perfNow, domComplete: _perfNow,
        loadEventStart: _perfNow, loadEventEnd: _perfNow
    },
    timeOrigin: _perfNow,
...
global.crypto = {
    ...
    subtle: {}, randomUUID: function () { return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'; }
};
...
global.fetch = function () { }; global.Intl = {};
global.AbortController = function () { }; global.AbortSignal = function () { };
