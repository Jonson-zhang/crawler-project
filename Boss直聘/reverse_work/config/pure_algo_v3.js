// Pure algorithm v3 — extracted from browser VMP trace
// 4622 unique operations

var _seed, _ts;  // inputs
...
function generateToken(seed, ts) {
  ...
  var lp,pp,ap,_p,cp,ep,tp,yp,op,vp,np,ip,sp,dp,hp,up,mp,gp,fp,Sp,bp,Cp,Ep,Rp,Tp,Ap,Mp,Dp,Lp,Gp,xp,Np,Pp,Vp,wp,Ip,Bp,Op,kp,Wp,jp,Fp,zp,Hp,Up,Jp,Zp,Kp,Xp,Qp,qp,Yp,$p;
  var la,pa,aa,_a,ca,ea,ta,ya,oa,va,ra,na,ia,sa,da,ha,ua,ma,ga,fa,Sa,ba,Ca,Ea,Ra,Ta,Aa,Ma,Da,La,Ga,xa,Na,Pa,Va,wa,Ia,Ba,Oa,ka,Wa,ja,Fa,za,Ha,Ua,Ja,Za,Ka,Xa,Qa,qa,Ya,$a;
