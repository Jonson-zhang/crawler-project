/**
 * v13: v12 + constructor.name fixes + crypto.subtle(SubtleCrypto) + crypto.randomUUID + screen.orientation +
 *      navigator.connection + performance.timeOrigin + Intl + AbortController
 *
 * 用法: node sign_boss_v13.js <__a> <__c> <seed> <ts>
 */
...
// v13: Fix constructor names (VMP checks X.constructor.name)Object.defineProperty(Navigator_,"name",{value:"Navigator"});Object.defineProperty(Document_,"name",{value:"HTMLDocument"});Object.defineProperty(HTMLEl,"name",{value:"HTMLElement"});Object.defineProperty(HTMLHtmlEl,"name",{value:"HTMLHtmlElement"});Object.defineProperty(HTMLBodyEl,"name",{value:"HTMLBodyElement"});Object.defineProperty(HTMLHeadEl,"name",{value:"HTMLHeadElement"});Object.defineProperty(HTMLCanvasEl,"name",{value:"HTMLCanvasElement"});Object.defineProperty(HTMLIFrameEl,"name",{value:"HTMLIFrameElement"});Object.defineProperty(HTMLScriptEl,"name",{value:"HTMLScriptElement"});Object.defineProperty(Location_,"name",{value:"Location"});Object.defineProperty(Screen_,"name",{value:"Screen"});Object.defineProperty(History_,"name",{value:"History"});Object.defineProperty(Storage_,"name",{value:"Storage"});Object.defineProperty(Performance_,"name",{value:"Performance"});Object.defineProperty(MemoryInfo_,"name",{value:"MemoryInfo"});Object.defineProperty(SubtleCrypto_,"name",{value:"SubtleCrypto"});Object.defineProperty(Crypto_,"name",{value:"Crypto"});Object.defineProperty(PluginArray_,"name",{value:"PluginArray"});Object.defineProperty(MimeTypeArray_,"name",{value:"MimeTypeArray"});Object.defineProperty(Plugin_,"name",{value:"Plugin"});Object.defineProperty(MimeType_,"name",{value:"MimeType"});Object.defineProperty(EvtTgt,"name",{value:"EventTarget"});
