"""
今日头条 — 财经频道 API (iv8 + 旧版 SDK 02_code.js)
...
from toutiao_sign import ToutiaoSigner
...
class ToutiaoFeed:
    ...
    def _register_ttwid(self):
        self._session.post(
            ...
            json={
                "region": "cn", "aid": 24, "needFid": False,
    ...
    def _get_mstoken(self, channel, page):
        resp = self._session.get("https://www.toutiao.com/api/pc/list/feed", params={
            "channel_id": channel, "max_behot_time": page,
            "category": "pc_profile_channel", "aid": "24", "app_name": "toutiao_web",
        })
...
if __name__ == "__main__":
    ...
    print(f"今日头条 - 财经频道 (iv8 + 旧版 SDK) channel={CHANNEL_ID}")
    print("=" * 60)
